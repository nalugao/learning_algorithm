...
def test_stack():
    ...
    assert stack.get() == 2, "get element should be the last added element"
    assert stack.get() == 1, "get element should be the first added element"
...
def test_queue():
    ...
    assert queue.get() == 1, "get element should be the first addd element"
    assert queue.get() == 2, "get element should be the second addd element"
...
def test_stack2():
    ...
    stack.add(4)
    assert stack, "Stack should not be empty after adding elements"
    assert stack.get() == 4, "get element should be the last added element"
